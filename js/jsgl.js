...
jsgl={
  /**
   * @namespace Holds functionality related to JSGL elements.jsgl.elements.GroupElement=function(domPr
   */     
  elements: {
...
//DR
 try{this.domRoot.removeChild(element.getDomPresenter().getXmlElement())}catch(e){};
...
jsgl.elements.GroupElement.prototype.getRotation = function() {
	return this.rotation;
}

jsgl.elements.GroupElement.prototype.setRotation = function(newRotation) {
	this.rotation=newRotation;
	this.onChangeRaiser.raiseEvent();
}

jsgl.elements.GroupElement.prototype.getRotationX = function() {
	return this.rotationX;
}

jsgl.elements.GroupElement.prototype.getRotationY = function() {
	return this.rotationY;
}

jsgl.elements.GroupElement.prototype.setRotationY = function(rotationY) {
	this.rotationY=rotationY;
}

jsgl.elements.GroupElement.prototype.setRotationX = function(rotationX) {
...
jsgl.elements.SvgGroupDomPresenter.prototype.update = function() {
	...
	if (this.graphicsElement.rotationX) this.svgGroupElement.setAttribute("transform","translate("+location.X+","+location.Y+") rotate("+this.graphicsElement.rotation+","+this.graphicsElement.rotationX+","+this.graphicsElement.rotationY+")")
	else this.svgGroupElement.setAttribute("transform","translate("+location.X+","+location.Y+") rotate("+this.graphicsElement.rotation+")")
}; 
